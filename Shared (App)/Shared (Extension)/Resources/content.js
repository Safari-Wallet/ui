...
})({"3C1kd":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "085de97347f46036";
"use strict";
...
window.addEventListener(`message`, (event)=>{
    ...
    if (event.data.method) Messenger.sendToBackground(event.data.method, event.data.params);
});
log(`loaded`);

},{"../ethereum":"ib3eQ","../utils":"jxYDB","../messaging":"3eVzl","./sessions":"02nhl"}],"ib3eQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "inject", ()=>inject
);
var _utils = require("../utils");
const log = _utils.getLogger('ethereum');
    ...
    request(payload) {
        return new Promise((resolve, reject)=>{
            ...
            window.addEventListener('message', (event)=>{
                ...
                if (payload.method === 'eth_requestAccounts' && method === 'walletConnected') {
                    resolve([
                        params.address
                    ]);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","../utils":"jxYDB"}],"ciiiV":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"3eVzl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["3C1kd","h2Qcl"], "h2Qcl", "parcelRequireae3a")
